    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_section', models.CharField(blank=True, max_length=10, null=True)),
                ('student_image', models.ImageField(upload_to='student_image/')),
                ('slug', models.SlugField(blank=True, max_length=100, null=True, unique=True)),
                ('roll_number', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='student_roll_number', to='myapp.rollnumber')),
            ],
        ),
    ]
